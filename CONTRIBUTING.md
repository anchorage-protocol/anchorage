...
Anchorage is in Phase 2 (single-cause public instance, opened 2026-05-14; Phase 1's adversary testbed closed the same day). The design docs, the v0 MCP server, the testbed harness, and the Phase 2 slice plan are all open to contribution. The code surface for Phase 2 slices 1–7 (live-fetch verification through operational tooling) closed 2026-05-14 / 2026-05-15; what remains for the Phase 2 exit criterion is slice 8 (first testbed-caught governance change — an operational milestone met during real Phase 2 operation, not a code slice; see [ROADMAP §Phase 2](./ROADMAP.md#phase-2--single-cause-public-instance-opened-2026-05-14)). Appropriate contribution today is the standing surfaces — testbed extension, design pressure-testing, editorial sharpening — plus bug fixes and refinements against the closed slice surface; the slice plan stops being the load-bearing frontier and starts being the operating substrate. This file describes the surfaces and the flow.
